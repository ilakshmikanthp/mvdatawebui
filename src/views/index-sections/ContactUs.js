...
class ContactUs extends React.Component {
	...
	render(){
		...
		<br/>							<form action="ContactHandler.asp" method="post" role="form" id="contact-form">
										...
										<div className="form-group">
											...
											<input type="text" className="form-control" id="name" value={this.state.name} onChange={this.onNameChange.bind(this)}  name="name"/>
										</div>
										<div className="form-group">
								...
								<div className="col-md-4 ml-auto">
									<div className="info info-horizontal">
										<div className="icon icon-primary">
											<i class="fas fa-map-marker-alt fa-3x customColor-1"></i>
										</div>
									...
									<div className="info info-horizontal">
										<div className="iconConUs">
											<i class="fa fa-phone fa-3x customColor-1" aria-hidden="true"></i>
										</div>
										<div className="description">
											<h4 className="info-title">Give us a ring</h4>
											<p>
												<a href="tel:+919986677208">+91 998 6677 208</a>
											</p>
										</div>
									</div>
									<div className="info info-horizontal">
										<div className="icon icon-primary">
											<i class="fa fa-envelope fa-3x customColor-1" aria-hidden="true"></i>
										</div>
										<div className="description">
